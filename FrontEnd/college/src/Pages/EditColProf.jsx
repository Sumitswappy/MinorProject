...
const EditColProf = () => {
    ...
    if (collegeData.brochurefileUri !== "" && collegeData.filename !== "") {
      ...
      // Continue with form submission
        ...
        .then((resp) => {
          ...
          console.log("id2:", userIdFromResponse); 
          ...
          const endpointUrl = `http://localhost:8080/user/update/${userIdFromResponse}`;
           Axios.put(endpointUrl, {
            ...
            password: '',
            photofile: resp.data[0].photofile,
            profilephotoUri: resp.data[0].profilephotoUri,
            isAdmin: resp.data[0].isAdmin,
        isCollegeUser: true,
      ...
      .then((res) => {
        ...
        Axios.put(fullurl, updatedCollegeData)
          .then((res) => {
            ...
            navigate("/CollegesProfile", { state: { id: collegeData.id } })
          })
          .catch((error) => {
  ...
  >
    College Profile
            ...
            <MDBBreadcrumbItem>
              <a href="/editcolprofile" className="text-reset">
                <u>Edit College</u>
              </a>
            </MDBBreadcrumbItem>
        </MDBBreadcrumb>
