    ...
    <div>
      <MDBCarousel showControls light fade>
        ...
        <MDBCarouselItem itemId={2}>
          <img src='https://assets.telegraphindia.com/telegraph/2021/Dec/1639305481_iit-kharagpur.jpg' className='d-block w-100' alt='...' style={{ maxHeight: '400px' }} width="844" />
          <MDBCarouselCaption>
            <h5>IIT Kharagpur</h5>
          </MDBCarouselCaption>
        </MDBCarouselItem>
        <MDBCarouselItem itemId={3}>
          <img src='https://kiit.ac.in/wp-content/uploads/2018/07/KIIT-Campus-Front-Library.jpg' className='d-block w-100' alt='...' style={{ maxHeight: '400px' }} width="844"  />
          <MDBCarouselCaption>
